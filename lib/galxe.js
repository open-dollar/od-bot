...
export const updateGalxePointsForAllUsers = async (campaignId) => {
    const campaignIds = ["GCHpqttjuU", "GCJGCth5pr"]
    ...
    console.log(`Updating ${usersWithNewPoints.length} Galxe users out of ${totalCount}`)
    ...
    return { updated: usersWithNewPoints.length, total: totalCount }
}
