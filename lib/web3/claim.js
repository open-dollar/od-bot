...
export const claim = async (network, userAddress, channelId) => {
  ...
  await checkGasAndAirdrop({ network, address: userAddress, channelId });
  const geb = initGeb(network);
