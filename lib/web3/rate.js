...
export const shouldUpdateRate = async (network, channelId) => {
...
export const updateRate = async (network, channelId) => {
  const geb = initGeb(network);
  const ready = await shouldUpdateRate(network, channelId);
