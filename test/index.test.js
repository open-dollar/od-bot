...
const test = async () => {
  try {
    ...
    // response = await fetch(
    //   `http://localhost:3000/api/analytics?secret=${process.env.RATE_SECRET}&network=OPTIMISM`
    // );
    ...
    response = await fetch(
      `http://localhost:3000/api/user?address=0x9492510BbCB93B6992d8b7Bb67888558E12DCac4&network=OPTIMISM&secret=${process.env.RATE_SECRET}`
    );
